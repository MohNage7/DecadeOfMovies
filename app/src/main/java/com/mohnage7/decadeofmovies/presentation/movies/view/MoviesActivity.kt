package com.mohnage7.decadeofmovies.presentation.movies.view
...
import com.mohnage7.decadeofmovies.framework.extentions.makeGone
import com.mohnage7.decadeofmovies.framework.extentions.makeVisible
import com.mohnage7.decadeofmovies.framework.extentions.observe
import com.mohnage7.decadeofmovies.framework.extentions.replaceFragment
import com.mohnage7.decadeofmovies.presentation.model.DataWrapper
import com.mohnage7.decadeofmovies.presentation.model.DataWrapper.Status
import com.mohnage7.decadeofmovies.presentation.model.Movie
import com.mohnage7.decadeofmovies.presentation.moviedetails.view.MovieDetailFragment
import com.mohnage7.decadeofmovies.presentation.moviedetails.view.MovieDetailsActivity
import com.mohnage7.decadeofmovies.presentation.movies.view.adapter.MoviesAdapter
import com.mohnage7.decadeofmovies.presentation.movies.view.adapter.SearchAdapter
...
class MoviesActivity : AppCompatActivity(), MovieClickListener {
    ...
    private fun setMoviesAdapter(data: List<Movie>?) {
        data?.let {
            // for movieClickListener we can also use lambda to execute the same behaviour
